...
INSERT INTO "new_CountdownSettings" ("backgroundColor", "buttonLink", "buttonText", "countdownType", "createdAt", "enabled", "endTime", "evergreenMinutes", "headline", "id", "message", "shop", "textColor", "updatedAt") SELECT "backgroundColor", "buttonLink", "buttonText", "countdownType", "createdAt", "enabled", "endTime", "evergreenMinutes", "headline", "id", "message", "shop", "textColor", "updatedAt" FROM "CountdownSettings";
